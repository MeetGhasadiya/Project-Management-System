    ...
    <body>
        ...
        if (empty($fid)) {
            ...
            if (isset($_POST['btnupdate'])) {
                ...
                // Update query
                $update = "UPDATE faculty SET fname='$fname', designation='$designation', email='$email', contactnumber='$contactno' WHERE fid=$fid";
        ...
        <form method="POST" class="form-container">
            <table align="center" class="update-tbl">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="txtname" value="<?php echo $row['fname']; ?>" required pattern="^[a-zA-Z\s]+$" title="Please enter a valid name using letters only.">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="txtdesignation" value="<?php echo $row['designation']; ?>" required>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="tel" id="txtpn" name="txtpn" value="<?php echo $row['contactnumber']; ?>" required pattern="[0-9]{10}" maxlength="10" title="Please enter a valid 10-digit phone number.">
                    </td>
                </tr>
                ...
                <tr>
                    <td></td>
                    <td align="center">
                        <input type="submit" value="Cancle" class="btn-submit" name="cancel" formaction="AddFaculty.php">   
                        <input type="submit" value="Edit" class="btn-submit" name="btnupdate">
